...
function vr_frases_dash_widget() {
	...
	echo '<ul><li>' . esc_html__( 'Your classification handlers: ', 'vr-frases' ) . '<a href="' . esc_url( admin_url( 'admin.php?page=vrfr_manageclases' ) ) . '">' . esc_html( $clases ) . ' ' . esc_html__( 'Classes', 'vr-frases' ) . '</a>' . esc_html__( ' and ', 'vr-frases' ) . '<a href="' . esc_url( admin_url( 'admin.php?page=vrfr_managetemas' ) ) . '">' . esc_html( $temas ) . ' ' . esc_html__( 'Themes', 'vr-frases' ) . '</a>.</li></ul>'; // Escape.
